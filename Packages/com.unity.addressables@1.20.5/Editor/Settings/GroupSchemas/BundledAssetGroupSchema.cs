...
//    [CreateAssetMenu(fileName = "BundledAssetGroupSchema.asset", menuName = "Addressables/Group Schemas/Bundled Assets")]
    ...
    public class BundledAssetGroupSchema : AddressableAssetGroupSchema, IHostingServiceConfigurationProvider, ISerializationCallbackReceiver
    {
        ...
        [FormerlySerializedAs("m_dataStreamProcessorType")]
        [SerializeField]
        [Tooltip("加密类型")]
        private int m_DataStreamProcessorType;

        /// <summary>
        /// The type of data stream processor.  This can be provided to implement bundle encryption.
        /// </summary>
        public int DataStreamProcessorType
        {
            get { return m_DataStreamProcessorType; }
            
            set
            {
                m_DataStreamProcessorType = value;
                SetDirty(true);
            }
        }
        ...
        GUIContent m_DataStreamProcessorContent = new GUIContent("Data Stream Processor", "加密类型");
        ...
        void ShowAdvancedProperties(SerializedObject so)
        {
            ...
            EditorGUILayout.PropertyField(so.FindProperty(nameof(m_DataStreamProcessorType)), m_DataStreamProcessorContent, true);
        }
